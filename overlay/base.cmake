...
if(MSVC)
	...
	# Windows 7 x64 (Win32 API 6.1). Keep these on the compiler command line so
	# they win over SDK headers that otherwise default to a newer NTDDI.
	set(CMAKE_C_FLAGS "${CMAKE_C_FLAGS} /D_WIN32_WINNT=0x0601 /DWINVER=0x0601 /DNTDDI_VERSION=0x06010000")
	set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} /D_WIN32_WINNT=0x0601 /DWINVER=0x0601 /DNTDDI_VERSION=0x06010000")
	...
	# /bigobj large JIT / JUCE BinaryData translation units (C1128)
	...
	# GitHub Actions windows-2022 is ~7 GB. /MP + /GL + cmake --parallel
	# launches enough cl.exe copies of BinaryData/JIT to OOM (exit 1, no C error).
	if(DEFINED ENV{CI})
		message(STATUS "CI: skipping /MP and /GL (GitHub Actions RAM)")
	else()
	...
	if(DEFINED ENV{CI})
		...
		set(CMAKE_SHARED_LINKER_FLAGS_RELEASE "${CMAKE_MODULE_LINKER_FLAGS_RELEASE} /DEBUG")
	...
	set(CMAKE_MODULE_LINKER_FLAGS "${CMAKE_MODULE_LINKER_FLAGS} /SUBSYSTEM:WINDOWS,6.01 /SAFESEH:NO")
	set(CMAKE_SHARED_LINKER_FLAGS "${CMAKE_SHARED_LINKER_FLAGS} /SUBSYSTEM:WINDOWS,6.01 /SAFESEH:NO")
